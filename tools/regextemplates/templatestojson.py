...
sys.path.append(head_location + "/adviser2.0")
...
if __name__ == '__main__':
    ...
    parser.add_argument("filename", help=".nlu filename (without .nlu, placed in resources/nlu_regexes)")
    args = parser.parse_args()
    nlu_file = os.path.join(head_location, 'resources', 'nlu_regexes', args.filename)
