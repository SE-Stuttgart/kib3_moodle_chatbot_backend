...
class GUIServer(Service):
    ...
    def start_dialog(self, user_id: str = "default", message: str = ""):
        # TODO logging instead of printing
        print("SERVICE", message)
        return {Topic.DIALOG_END: message}

    @PublishSubscribe(sub_topics=['gen_user_utterance'])
    def forward_message_to_react(self, user_id: str = "default", gen_user_utterance: str = ""):
    ...
    def forward_message_to_react(self, user_id: str = "default", emotion = None):
    ...
    def forward_message_to_react(self, user_id: str = "default", engagement = None):
    ...
    def user_utterance(self, user_id: str = "default", message = ""):
    ...
    def forward_message_to_react(self, user_id: str = "default", sys_utterance = None):
