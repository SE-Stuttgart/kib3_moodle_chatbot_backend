...
from services.nlg.templates.parsing.parsers.constraintparser.constraintparser import ConstraintParser
...
class SpecialCase(Command):
    ...
    def apply(self, parameters: Memory) -> str:
        ...
        potential_messages = self._extract_potential_messages(parameters)
        return self._select_message(potential_messages).apply(parameters)
